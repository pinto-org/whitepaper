...
\begin{itemize}[topsep=0pt, itemsep=3pt,leftmargin=16pt]
    ...
    \item[] $D_{\gamma}$ - The number of \term{Unharvestable Pods} that grew prior to the \term{Flood};
    \item[] $D_{\gamma}^{F}$ - The maximum percent of the Pinto supply worth of \term{Pods} that grew from Pinto \term{Sown} before it began to \term{Rain} that become \term{Harvestable} during a \term{Flood};
